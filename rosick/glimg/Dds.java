...
import static rosick.glimg.ImageFormat.Bitdepth.*;
import static rosick.glimg.ImageFormat.ComponentOrder.*;
import static rosick.glimg.ImageFormat.PixelComponents.*;
import static rosick.glimg.ImageFormat.PixelDataType.*;
...
import rosick.glimg.ImageCreator.BadFaceCountException;
import rosick.glimg.ImageCreator.CubemapsMustBe2DException;
import rosick.glimg.ImageCreator.No3DTextureArrayException;
import rosick.glimg.ImageCreator.NoImagesSpecifiedException;
...
public class Dds {
	...
	private static int calcByteOffsetToImage(UncheckedImageFormat fmt, Dimensions dims, int mipmapLevel, int i, int j) {
		...
		for (int currLevel = 0; currLevel < mipmapLevel; currLevel++) {
			/*
			Dimensions mipmapDims = modifySizeForMipmap(dims, currLevel);
