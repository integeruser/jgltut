package rosick.glimg;

import java.util.ArrayList;

import rosick.glimg.ImageFormat.Bitdepth;
import rosick.glimg.ImageFormat.PixelComponents;
import rosick.glimg.ImageFormat.PixelDataType;
import rosick.glimg.ImageFormat.UncheckedImageFormat;
import rosick.glimg.ImageSet.Dimensions;
import rosick.glimg.ImageSet.ImageSetImpl;
...
public class ImageCreator {
	...
	private int calcBytesPerPixel(ImageFormat fmt) {
		int bytesPerPixel = 0;
		switch(fmt.depth()) {
	...
	private int componentCount(PixelComponents eFormat) {
	...
	PixelComponents g_twoCompFormats[] = {PixelComponents.FMT_COLOR_RG, PixelComponents.FMT_DEPTH_X};
	PixelComponents g_threeCompFormats[] = {PixelComponents.FMT_COLOR_RGB, PixelComponents.FMT_COLOR_RGB_sRGB};
	PixelComponents g_fourCompFormats[] = {PixelComponents.FMT_COLOR_RGBX, PixelComponents.FMT_COLOR_RGBA,
			PixelComponents.FMT_COLOR_RGBX_sRGB, PixelComponents.FMT_COLOR_RGBA_sRGB};

	boolean isOneOfThese(PixelComponents testValue, PixelComponents testArray[]) {
