 ...
 */
public class HDRLighting02 extends GLWindow {
	...
	private void setupHDRLighting() {
		SunlightValueHDR values[] = {
				new SunlightValueHDR(0.0f/24.0f, new Vec4(0.6f, 0.6f, 0.6f, 1.0f), new Vec4(1.8f, 1.8f, 1.8f, 1.0f), g_skyDaylightColor, 3.0f),
				new SunlightValueHDR(4.5f/24.0f, new Vec4(0.6f, 0.6f, 0.6f, 1.0f), new Vec4(1.8f, 1.8f, 1.8f, 1.0f), g_skyDaylightColor, 3.0f),
				...
				new SunlightValueHDR(20.5f/24.0f, new Vec4(0.6f, 0.6f, 0.6f, 1.0f), new Vec4(1.8f, 1.8f, 1.8f, 1.0f), g_skyDaylightColor, 3.0f),
		};
