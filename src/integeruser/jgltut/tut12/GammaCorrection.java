 ...
 * Original: https://bitbucket.org/alfonse/gltut/src/default/Tut%2012%20Dynamic%20Range/Gamma%20Correction.cpp
 * <p>
...
public class GammaCorrection extends Tutorial {
    ...
    ////////////////////////////////
    // View setup.
    private MousePoles.ViewData initialViewData = new MousePoles.ViewData(
    ...
    private MousePoles.ViewScale viewScale = new MousePoles.ViewScale(
            3.0f, 80.0f,
            4.0f, 1.0f,
            5.0f, 1.0f,
            90.0f / 250.0f
    ...
    private MousePoles.ViewPole viewPole = new MousePoles.ViewPole(initialViewData, viewScale, MousePoles.MouseButtons.MB_LEFT_BTN);
