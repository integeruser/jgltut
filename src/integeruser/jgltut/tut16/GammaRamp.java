...
import integeruser.jglsdk.glimg.StbLoader;
 ...
 * Original: https://bitbucket.org/alfonse/gltut/src/default/Tut%2016%20Gamma%20and%20Textures/GammaRamp.cpp
 * <p>
 * Part IV. Texturing
...
public class GammaRamp extends Tutorial {
    ...
    private void loadTextures() {
        ...
        try {
            ...
            ImageSet.SingleImage image = imageSet.getImage(0, 0, 0);
            ImageSet.Dimensions imageDimensions = image.getDimensions();

            TextureGenerator.OpenGLPixelTransferParams pxTrans = TextureGenerator.getUploadFormatType(imageSet.getFormat(), 0);
