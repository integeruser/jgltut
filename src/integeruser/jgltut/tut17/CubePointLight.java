...
public class CubePointLight extends Tutorial {
    ...
    protected void init() {
        ...
        GL15.glBufferData(GL_UNIFORM_BUFFER, ProjectionBlock.SIZE_IN_BYTES, GL_STREAM_DRAW);
    ...
    private void loadAndSetupScene() {
        ...
        lightProjMatBinder = new SceneBinders.UniformMat4Binder();
        ...
        camLightPosBinder = new SceneBinders.UniformVec3Binder();
    ...
    private SceneBinders.UniformMat4Binder lightProjMatBinder;
    private SceneBinders.UniformVec3Binder camLightPosBinder;
    ...
    private void loadTextures() {
        try {
            for (int textureIndex = 0; textureIndex < NUM_LIGHT_TEXTURES; textureIndex++) {
                ...
                ImageSet.Dimensions imageDimensions = imageSet.getDimensions();
                int imageFormat = TextureGenerator.getInternalFormat(imageSet.getFormat(), 0);

                for (int face = 0; face < 6; ++face) {
                    ImageSet.SingleImage singleImage = imageSet.getImage(0, 0, face);
