package jgltut.jglsdk.glimg;

import jgltut.jglsdk.glimg.ImageFormat.*;
...
public class DdsLoader {
    ...
    private static OldDdsFormatConv oldFormatConvert[] = {
            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGBA, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS, 32, 0xff, 0xff00, 0xff0000, 0xff000000, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGBA, ComponentOrder.BGRA, BitDepth.PACKED_32_BIT_8888_REV, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS, 32, 0xff0000, 0xff00, 0xff, 0xff000000, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGBX, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 32, 0xff, 0xff00, 0xff0000, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGB, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGB, ComponentOrder.BGRA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 24, 0xff0000, 0xff00, 0xff, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGB, ComponentOrder.RGBA, BitDepth.PACKED_16_BIT_565, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xf800, 0x7e0, 0x1f, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGBA, ComponentOrder.BGRA, BitDepth.PACKED_16_BIT_1555_REV, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0x7c00, 0x3e0, 0x1f, 0x8000, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RGBA, ComponentOrder.BGRA, BitDepth.PACKED_16_BIT_4444_REV, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xf00, 0xf0, 0xf, 0xf000, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.COMPRESSED_BC1, PixelComponents.COLOR_RGB, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0, 0, MagicNumbers.DDSFOURCC_DXT1)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.COMPRESSED_BC2, PixelComponents.COLOR_RGBA, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0, 0, MagicNumbers.DDSFOURCC_DXT3)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.COMPRESSED_BC3, PixelComponents.COLOR_RGBA, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0, 0, 0, 0, MagicNumbers.DDSFOURCC_DXT5)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RG, ComponentOrder.RGBA, BitDepth.PER_COMP_16, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 32, 0xffff, 0xffff0000, 0, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RG, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xffff, 0xffff0000, 0, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RED, ComponentOrder.RGBA, BitDepth.PER_COMP_16, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.LUMINANCE, 16, 0xffff, 0, 0, 0, 0)
            ),

            new OldDdsFormatConv(
                    new UncheckedImageFormat(PixelDataType.NORM_UNSIGNED_INTEGER, PixelComponents.COLOR_RED, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
